...
class HelpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final topics = <_HelpTopic>[
      ...
      _HelpTopic(l10n.helpGroupsTitle, l10n.helpGroupsBody),
      _HelpTopic(l10n.helpRequestsTitle, l10n.helpRequestsBody),
      _HelpTopic(l10n.helpSecurityTitle, l10n.helpSecurityBody),
      _HelpTopic(l10n.helpSafetyNumberTitle, l10n.helpSafetyNumberBody),
      _HelpTopic(l10n.helpTorTitle, l10n.helpTorBody),
      _HelpTopic(l10n.helpLockTitle, l10n.helpLockBody),
      _HelpTopic(l10n.helpAutoLockTitle, l10n.helpAutoLockBody),
      _HelpTopic(l10n.helpContactOptionsTitle, l10n.helpContactOptionsBody),
